...
bash scripts/verify_deb.sh packages/com.murkaska.virtualcampro_2.12.0_iphoneos-arm64.deb
```
...
```bat
install-phone.bat PHONE_IP "D:\Downloads\com.murkaska.virtualcampro_2.12.0_iphoneos-arm64.deb" 22
```
